...
The third parameter should be named areaPerBucket of type double. This parameter represents the area that can be covered with one bucket of paint.
The fourth parameter should be named extraBuckets of type int. This parameter represents the bucket count that Bob has at home.
...
This method needs to return a value of type int that
represents the number of buckets that Bob needs to buy before going to work. To calculate the bucket count, refer to the notes below.
